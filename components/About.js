...
const About = () => {
  ...
  return (
    <div id="about" className="about py-[20px] px-[5%]">
        <h3 className='font-bold text-center text-gray-700 text-2xl md:text-4xl my-3 md:my-10'>About Jagger d.o.o.</h3>
        <div className='grid grid-cols-1 md:grid-cols-2 justify-items-center items-center py-5'>
            ...
            <div className="about-img mx-10 p-2 w-[300px] md:w-auto">
              <Carousel autoPlay={true} infiniteLoop={true}>
                {
                  images.map(item => {
                    return(
                      <div key={item.id}>
                       <img className='shadow-full rounded-xl' src={item.src} alt='jagger-welding-man-welding'/>
