...
const About = () => {
  return (
    <div className="about py-[50px] px-[5%]">
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 justify-items-center items-center'>
            ...
            <div className="about-img">
                <Image className='hover:scale-105 shadow-full ' src='/images/features/man_welding.png' height={400} width={400} alt='jagger-welding-man-welding'/>
            </div>
        </div>
    </div>
