    ...
    >
        <div className="overlay h-full flex w-full justify-center md:justify-end items-center text-white px-[2%] md:px-20">
            <div className="text-overlay text-center md:text-left w-full md:w-[50%] p-2">
                ...
                <div className='text-4xl  bg-gradient-to-b from-sky-500 to-sky-700 p-2 md:text-8xl uppercase russo-font'>
                <TypeAnimation
                ...
                <div className="hero-btn mt-5 flex gap-3 justify-center md:justify-start font-bold ">
                    <button className='shadow-lg hover:shadow-sky-600/50  md:w-auto text-xs md:text-md bg-gradient-to-b hover:bg-gradient-to-t from-sky-500 to-sky-700 text-white px-2 py-2'>
                      <a className='flex justify-center items-center gap-1' href="tel: +386 41 637 807">
                      <IoCallSharp /> 
                      +386 41 637 807
                      </a>
                    </button>
                    <button className='shadow-lg hover:shadow-sky-600/50  md:w-auto text-xs md:text-md bg-gradient-to-b hover:bg-gradient-to-t from-sky-500 to-sky-700  text-white px-5 py-2'>
