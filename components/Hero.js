  ...
  return (
    <div id='home' className="h-[60vh] relative"> 
           <Carousel autoPlay={true} infiniteLoop={true} showThumbs={false} showArrows={false} showStatus={false} showIndicators={false}>
            ...
            <div className='bg-black backdrop-blur-sm w-full bg-opacity-70 h-full flex items-center justify-center py-10 z-10 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>
