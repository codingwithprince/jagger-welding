    ...
    >
        <div id='home' className="overlay h-full flex w-full justify-center md:justify-end items-center text-white px-[2%] md:px-20">
            <div className="text-overlay text-center md:text-left w-full md:w-[50%] p-2">
                ...
                <div className="hero-btn mt-5 flex gap-3 justify-center md:justify-start">
                    <button className='shadow-lg rounded-md hover:shadow-sky-600/50  md:w-auto text-xs md:text-lg bg-gradient-to-b hover:bg-gradient-to-t from-sky-500 to-sky-700 text-white px-2 py-2'>
